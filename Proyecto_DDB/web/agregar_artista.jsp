            ...
            <div class="row ">
                ...
                <div class="col-md-10 top-1000">
                    <div class="container">
                        <%
                            if (ar != null) {
                                Usuario ua = (Usuario) session.getAttribute("ua");
                                out.println("<form action=\"Actualizar?op=3\" method=\"post\">	     		\n"
                                        + "                            <div class=\"form-group tam \">\n"
                                        + "                                <input type=\"text\" name=\"name\" value='"+ua.getNombre()+"'  class=\"form-control\" id=\"exampleInputEmail1\" aria-describedby=\"emailHelp\" placeholder=\"Nombre del artista\">    \n"
                                        + "                            </div>\n"
                                        + "                            <div class=\"form-group\">\n"
                                        + "                                <input type=\"text\" name=\"ap\" value='"+ua.getApellido_p()+"' class=\"form-control\" id=\"exampleInputPassword1\" placeholder=\"Apellido Paterno\">\n"
                                        + "                            </div>\n"
                                        + "                            <div class=\"form-group\">\n"
                                        + "                                <input type=\"text\" name=\"am\" value='"+ua.getApellido_m()+"' class=\"form-control\" id=\"exampleInputEmail1\" aria-describedby=\"emailHelp\" placeholder=\"Apellido Materno\">   \n"
                                        + "                            </div>\n"
                                        + "                    <div class=\"form-group\">\n"
                                        + "                        <input type=\"email\" name =\"email\" value='"+ua.getEmail()+"' class=\"form-control\" id=\"exampleInputEmail1\" aria-describedby=\"emailHelp\" placeholder=\"Enter email\">    \n"
                                        + "                    </div>\n"
                                        + "                    <div class=\"form-group\">\n"
                                        + "                        <input type=\"text\" name=\"user\" value='"+ua.getUsuario()+"' class=\"form-control\" id=\"exampleInputPassword1\" placeholder=\"Username\">\n"
                                        + "                    </div>\n"
                                        + "                    <div class=\"form-group\">\n"
                                        + "                        <input type=\"password\" name= \"pass\" value='"+ua.getContrasenia()+"' class=\"form-control\" id=\"exampleInputPassword1\" placeholder=\"Password\">\n"
                                        + "                    </div>\n"
                                        + "                            <div class=\"form-group\">\n"
                                        + "                                <input type=\"text\" name=\"desc\" value='"+ar.getDescripcion()+"' class=\"form-control\" id=\"exampleInputEmail1\" aria-describedby=\"emailHelp\" placeholder=\"Descripcion\">   \n"
                                        + "                            </div>\n"
                                ...
                                out.println("<form action=\"Agregar?op=3\" method=\"post\">	     		\n"
                                        ...
                                        + "                    </div>\n"
                                        + "                            <div class=\"form-group\">\n"
                                        + "                                <input type=\"text\" name=\"desc\" class=\"form-control\" id=\"exampleInputEmail1\" aria-describedby=\"emailHelp\" placeholder=\"Descripcion\">   \n"
                                        + "                            </div>\n"
                                        + "                            <center style=\"padding-top: 30px\">\n"
